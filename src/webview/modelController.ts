import { EPackage, EClass, EEnum, EAttribute, EReference, EOperation, EParameter } from '@tripsnek/tmf';
...
export class ModelController {
     ...
     */
    public addSubPackage(parentPkg: EPackage, name: string = 'NewPackage'): EPackage {
        this.saveState();
     ...
     */
    public addAttribute(eClass: EClass, name: string = 'newAttribute'): EAttribute {
        this.saveState();
     ...
     */
    public addReference(eClass: EClass, name: string = 'newReference'): EReference {
        this.saveState();
     ...
     */
    public addOperation(eClass: EClass, name: string = 'newOperation'): EOperation {
        this.saveState();
     ...
     */
    public addParameter(operation: EOperation, name: string = 'param'): EParameter {
        this.saveState();
